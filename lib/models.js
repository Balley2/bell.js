...
exports.register = function(sequelize) {
  ...
  var Receiver = sequelize.define('Receiver', {
    ...
    universal: {type: Sequelize.BOOLEAN, unique: true},
  });

  var ReceiverProjects = sequelize.define('ReceiverProjects', {
    email: {type: Sequelize.BOOLEAN, defaultValue: false},
    phone: {type: Sequelize.BOOLEAN, defaultValue: false},
  });
  ...
  exports.ReceiverProjects = ReceiverProjects;
  return exports;
};
