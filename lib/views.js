...
exports.register = function(service) {
  ...
  service.app.use(route.get(url('/admin/projects'), projects));
  service.app.use(route.get(url('/admin/project/:name'), project));
};
...
function *projects() {
  this.body = yield render('admin/projects.html');
}

function *project(name) {
  this.body = yield render('admin/project.html', {name: name});
}
