...
const errors = {
  ...
  ErrReceiverProjectEmail:        {code: 400, msg: "Invalid receiver to project email"},
  ErrReceiverProjectPhone:        {code: 400, msg: "Invalid receiver to project phone"},
  ErrReceiverProjectInvalid:      {code: 400, msg: "Invalid receiver to project request"},
};
