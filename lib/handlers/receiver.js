...
function *add(id) {
  ...
  var email = validators.validateReceiverProjectEmail(this.request.body.email);
  var phone = validators.validateReceiverProjectPhone(this.request.body.phone);
  if (!email && !phone)
    throw errors.ErrReceiverProjectInvalid;
  var options = {
