...
app.controller("project.edit",function(e,r,o){var t,n={};n.name={},n.name.form=$(".section-project-name form"),n.del={},n.del.button=$(".section-project-delete button.project-delete-confirmed"),n.del.error=$(".section-project-delete .error"),e.init=function(){t=window._ctx.id,e.load(),e.initEvents()},e.initEvents=function(){n.name.form.submit(e.patchName),n.del.button.click(e.deleteProject)},e.load=function(){r.project.getFull(t,function(o,t){return o?void r.error.error(o):void e.fillName(t)})},e.fillName=function(e){return o.fillForm(n.name.form,e)},e.patchName=function(e){e.preventDefault();var n=o.collectForm(this);r.project.patch(t,n.name,function(e,o){return e?void r.error.error(e):void r.error.ok("Project name updated")})},e.deleteProject=function(e){r.project.del(t,function(e,t){return e?void r.error.error(e):(r.error.ok("Project deleted, redirecting page in 3 seconds..",n.del.error),void setTimeout(function(){window.location.href=o.url("/admin/project")},3e3))})}});
app.controller("project",function(t,e,r){var o={};o.create={},o.create.form=$(".project-create form"),o.list={},o.list.table=$(".project-list tbody"),o.list.template=$(".project-list #template-project-node"),t.init=function(){t.list(),t.initCreate()},t.append=function(t){var e=o.list.template.html(),n=nunjucks.renderString(e,{project:t,url:r.url});o.list.table.append(n)},t.list=function(r){e.project.getAll(function(r,o){return r?void e.error.error(r):void o.forEach(t.append)})},t.initCreate=function(){o.create.form.submit(function(o){o.preventDefault();var n=r.collectForm(this);e.project.create(n.name,function(r,o){return r?void e.error.error(r):(t.append(o),void e.error.ok("Project created"))})})}});