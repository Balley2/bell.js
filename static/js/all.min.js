...
app.handler("receiver",function(e,r){e.create=function(e,n){return r.post(r.url("/api/admin/receiver"),e,n)},e.getAll=function(e){return r.get(r.url("/api/admin/receivers"),e)}});
...
app.controller("project.edit",function(e,r,t){var o,l={};l.name={},l.name.form=$(".section-project-name form"),l.del={},l.del.button=$(".section-project-delete button.project-delete-confirmed"),l.del.error=$(".section-project-delete .error"),l.rule={},l.rule.add={},l.rule.add.form=$(".section-project-rules form.rule-add"),l.rule.list={},l.rule.list.list=$(".section-project-rules .rule-list"),l.rule.list.template=$(".section-project-rules #template-rule-node"),l.rule.del={},l.rule.del.button=$(".section-project-rules button.rule-delete"),e.init=function(){o=window._ctx.id,e.loadProject(),e.loadRules(),e.initEvents()},e.initEvents=function(){l.name.form.submit(e.patchName),l.del.button.click(e.deleteProject),l.rule.add.form.submit(e.addRule)},e.loadProject=function(){r.project.get(o,function(e,o){return e?void r.error.error(e):void t.fillForm(l.name.form,o)})},e.loadRules=function(){r.rule.gets(o,function(t,o){return t?void r.error.error(t):void o.forEach(e.appendRule)})},e.appendRule=function(r,o){var n=l.rule.list.template.html(),i=nunjucks.renderString(n,{rule:r});l.rule.list.list.append(i);var d=t.format(".rule-list li[data-id*=%d]",r.id);$(d).appendTo(l.rule.list.list).show(o),$(d).find(".rule-delete").click(e.deleteRule)},e.removeRule=function(e){var r=t.format(".rule-list li[data-id*=%d]",e);$(r).hide(500,function(){$(r).remove()})},e.patchName=function(e){e.preventDefault();var l=t.collectForm(this);r.project.patch(o,l.name,function(e,t){return e?void r.error.error(e):void r.error.ok("Project name updated")})},e.deleteProject=function(e){r.project.del(o,function(e,o){return e?void r.error.error(e):(r.error.ok("Project deleted, redirecting page in 2 seconds..",l.del.error),void setTimeout(function(){window.location.href=t.url("/admin/project")},2e3))})},e.addRule=function(l){l.preventDefault();var n=t.collectForm(this),i=this;n.up="on"===n.up,n.down="on"===n.down,n.min=+n.min?+n.min:null,n.max=+n.max?+n.max:null,r.rule.add(o,n,function(t,o){return t?void r.error.error(t):(e.appendRule(o,500),void i.reset())})},e.deleteRule=function(t){var o=+$(this).data("id");r.rule.del(o,function(t,l){return t?void r.error.error(t):(r.error.ok("Rule deleted"),void e.removeRule(o))})}});
