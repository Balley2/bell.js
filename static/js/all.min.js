...
app.handler("project",function(t,n){t.create=function(t,e){return n.post(n.url("/api/admin/project"),{name:t},e)},t.getAll=function(t){return n.get(n.url("/api/projects"),t)},t.del=function(t,e){return n.del(n.url("/api/admin/project/"+t),e)},t.get=function(t,e,r){return 2==arguments.length&&(r=e,e={}),n.get(n.url("/api/project/"+t,e),r)},t.patch=function(t,e,r){return n.patch(n.url("/api/admin/project/"+t),{name:e},r)}});
app.handler("receiver",function(e,r){e.create=function(e,n){return r.post(r.url("/api/admin/receiver"),e,n)},e.getAll=function(e){return r.get(r.url("/api/admin/receivers"),e)},e.add=function(e,n,i){return r.post(r.url("/api/admin/project/"+e+"/receiver"),n,i)},e.gets=function(e,n){return r.get(r.url("/api/admin/project/"+e+"/receivers"),n)},e.remove=function(e,n,i){return r.del(r.url("/api/admin/project/"+e+"/receiver/"+n),i)}});
app.handler("rule",function(r,n){r.add=function(r,e,u){return n.post(n.url("/api/admin/project/"+r+"/rule"),e,u)},r.gets=function(r,e){return n.get(n.url("/api/admin/project/"+r+"/rules"),e)},r.del=function(r,e){return n.del(n.url("/api/admin/rule/"+r),e)}});
