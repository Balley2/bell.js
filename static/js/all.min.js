...
app.controller("receiver.edit",function(e,r,i){var o,t={};t.edit={},t.edit.form=$(".receiver-edit form"),t.edit.error=$(".receiver-edit .error"),e.init=function(){o=window._ctx.id,e.loadReceiver(),e.initEvents()},e.initEvents=function(){t.edit.form.submit(e.patchReceiver)},e.loadReceiver=function(){r.receiver.get(o,function(e,o){return e?void r.error.error(e,t.edit.error):void i.fillForm(t.edit.form,o)})},e.patchReceiver=function(e){e.preventDefault();var n=i.collectForm(t.edit.form);n.universal="on"===n.universal,n.enableEmail="on"===n.enableEmail,n.enablePhone="on"===n.enablePhone,r.receiver.patch(o,n,function(e,i){return e?void r.error.error(e,t.edit.error):void r.error.ok("Saved",t.edit.error)})}});
