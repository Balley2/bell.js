...
app.handler("error",function(r,n){var e=$("#template-error").html();r.render=function(r,n,t){if(r){t=t||"#error";var o=nunjucks.renderString(e,{type:n,msg:r.toString()});return $(t).html(o)}},r.fatal=function(n,e){throw r.render(n,"danger",e),new Error(n)},r.error=function(n,e){return r.render(n,"danger",e)},r.warn=function(n,e){return r.render(n,"warning",e)},r.info=function(n,e){return r.render(n,"info",e)},r.ok=function(n,e){return r.render(n,"success",e)}});
...
app.handler("project",function(t,e){t.create=function(t,n){return e.post(e.url("/api/admin/project"),{name:t},n)},t.getAll=function(t){return e.get(e.url("/api/projects"),t)},t["delete"]=function(t,n){return e["delete"](e.url("/api/admin/project/"+t),n)},t.get=function(t,n){return e.get(e.url("/api/project/"+t),n)},t.patch=function(t,n,r){return e.patch(e.url("/api/admin/project/"+t),{name:n},r)}});
...
app.controller("index",function(t,e,r){var n,o,a=$("#loader");t.init=function(){n=window._ctx.options,o=r.timeSpanToSeconds(n.past),e.chart.init({selector:"#chart",serverDelay:1e3*o,step:1e3*window._ctx.interval,stop:1==n.stop,type:n.type}),t.initScrollbars(),t.initSidebar(),r.setIntervalAndRunNow(function(){e.chart.remove(),t.getNames(function(e){t.renderStats(e),t.plot(e),t.initTitles(e)})},6e5)},t.feed=function(t,r){return e.chart.metric(function(a,i,s,l){var c=[],u=0;a=(+a-o)/1e3,i=(+i-o)/1e3,s=+s/1e3;var p={name:t,type:n.type,start:a,stop:i};e.metric.getData(p,function(t,n){if(t)return e.error.fatal(t);for(;i>a;){for(;a<n.times[u];)a+=s,c.push(a>n.times[u]?n.vals[u]:0);c.push(n.vals[u++]),a+=s}l(null,c),r&&r(n)})},t)},t.getNames=function(t){var r={limit:n.limit,sort:n.sort};n.project?r.project=n.project:r.pattern=n.pattern,e.metric.getNames(r,function(r,n){return r?e.error.fatal(r):(a.hide(),void(t&&t(n)))})},t.plot=function(r){var n,o,a=[];for(o=0;o<r.names.length;o++)n=r.names[o][0],a.push(t.feed(n,t.refreshTitle));return e.chart.plot(a)},t.renderStats=function(t){return r.render("#template-query-statistics","#query-statistics",t)},t.initTitles=function(o){var a,i,s,l={};for(a=0;a<o.names.length;a++)i=o.names[a][0],s=o.names[a][1],l[i]=s;return e.chart.title(function(e){var o=$("#template-title").html(),a=l[e];return nunjucks.renderString(o,{name:e,trend:a,trendText:t.getTextByTrend(a),className:t.getClassNameByTrend(a),url:r.url("/",{pattern:e,sort:n.sort,limit:1,type:n.type,past:n.past})})})},t.refreshTitle=function(e){$(r.format("title-%s",e.name)).toggleClass(t.getClassNameByTrend(e.trend)),$(r.format("title-trend-%s",e.name)).html(t.getTextByTrend(e.trend))},t.getClassNameByTrend=function(t){return Math.abs(t)>=1?"anomalous":"normal"},t.getTextByTrend=function(t){return t>0?"↑":0>t?"↓":"-"},t.initScrollbars=function(){$(".chart-box-top").scroll(function(){$(".chart-box").scrollLeft($(".chart-box-top").scrollLeft())}),$(".chart-box").scroll(function(){$(".chart-box-top").scrollLeft($(".chart-box").scrollLeft())})},t.initSidebar=function(){e.project.getAll(function(t,o){if(t)return e.error.error(t);var a,i,s,l,c,u;for(l=$("#projects"),c=$("#template-project-node").html(),a=0;a<o.length;a++)i=o[a],s=r.url("/",{project:i.id}),u=nunjucks.renderString(c,{name:i.name,url:s,current:n.project}),l.append(u)})}});
app.controller("project",function(t,e,r){t.init=function(){t.initProjectCreate(),t.listProject(),t.initProjectEdit()};var o={};o.project={},o.project.create={},o.project.create.modal=$(".project-create .modal"),o.project.create.form=$(".project-create form"),o.project.create.error=$(".project-create .error"),o.project.list={},o.project.list.tbody=$(".project-list table tbody"),o.project.list.template=$("#template-project-node"),o.project.edit={},o.project.edit.modal=$(".project-edit .modal"),o.project.edit.error=$(".project-edit .error"),o.project.edit.form={},o.project.edit.form.projectName=$(".project-edit form.project-name"),o.project.edit.form.projectDelete=$(".project-edit button.project-delete"),t.initProjectCreate=function(){o.project.create.form.submit(function(c){c.preventDefault();var i=r.collectForm(this);e.project.create(i.name,function(r,c){return r?void e.error.error(r,o.project.create.error):(o.project.create.modal.modal("hide"),t.appendProject(c),void e.error.ok("Project created"))})}),o.project.create.modal.on("hidden.bs.modal",function(t){o.project.create.error.html("")})},t.appendProject=function(t){var e=o.project.list.template.html(),c=nunjucks.renderString(e,{project:t,url:r.url});o.project.list.tbody.append(c);var i=r.format(".project-list table a[data-id*='%d']",t.id);$(i).click(function(t){t.preventDefault(),o.project.edit.modal.modal("show",$(this))})},t.listProject=function(){e.project.getAll(function(r,o){return r?void e.error.error(r):void o.forEach(t.appendProject)})},t.initProjectEdit=function(){t.initProjectEditModal()},t.initProjectEditModal=function(){o.project.edit.modal.on("show.bs.modal",function(e){var r=$(e.relatedTarget),o=r.data("id");t.fillProjectEditModal(o)})},t.fillProjectEditModal=function(t){e.project.get(t,function(t,c){return t?void e.error.error(t,o.project.edit.error):void r.fillForm(o.project.edit.form.projectName,c)})},t.initProjectEditName=function(){o.project.edit.form.projectName.submit(function(t){t.preventDefault();r.collectForm(this)})}});