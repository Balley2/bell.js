...
app.util.secondsToString=function(t){var r=new Date(1e3*t),e=r.getMonth()+1,n=r.getDate(),a=r.getHours(),s=r.getMinutes(),u=r.getSeconds();return e=("00"+e).slice(-2),n=("00"+n).slice(-2),a=("00"+a).slice(-2),s=("00"+s).slice(-2),u=("00"+u).slice(-2),[e,n].join("/")+" "+[a,s,u].join(":")},app.util.format=function(){var t=arguments,r=t[0],e=1;return r.replace(/%((%)|s|d|f)/g,function(r){if(r[2])return r[2];var n=t[e++];switch(r){case"%d":return parseInt(n);case"%f":return parseFloat(n);case"%s":return n.toString()}})},app.util.url=function(t,r){var e,n=[];if("/"!==t[0])throw new Error("except route starts with /");if(window._ctx.root&&(t="/"+window._ctx.root+t),r)for(e in r)n.push([e,"=",r[e]].join(""));var a=t+"?"+n.join("&");return a.replace(/\?$/g,"")},app.util.get=function(t,r){return $.ajax({type:"GET",url:t,dataType:"json",success:function(t){return r(null,t)},error:function(t,e){var n=JSON.parse(t.responseText),a=app.util.format("%s: %s",t.status,n.msg),s=new Error(a);return r(s,null)}})},app.util.post=function(t,r,e){return $.ajax({type:"POST",url:t,dataType:"json",contentType:"application/json",processData:!1,data:JSON.stringify(r),success:function(t){return e(null,t)},error:function(t,r){var n=JSON.parse(t.responseText),a=app.util.format("%s: %s",t.status,n.msg),s=new Error(a);return e(s,null)}})},app.util.timeSpanToSeconds=function(t){for(var r,e,n,a,s={s:1,m:60,h:3600,d:86400},u=0;t.length>0;){for(r=0;r<t.length;r++)if(e=t[r],n=s[e],!isNaN(n)){a=+t.slice(0,r),u+=a*n,t=t.slice(r+1);break}if(r===t.length)return u}return u},app.util.setIntervalAndRunNow=function(t,r){return t(),setInterval(t,r)},app.util.collectForm=function(t){var r={};return $(t).serializeArray().map(function(t){t.name&&(r[t.name]=t.value)}),r};
...
app.handler("error",function(r,n){var e=$("#template-error").html();r.render=function(r,n,t){if(r){t=t||"#error";var o=nunjucks.renderString(e,{type:n,msg:r.toString()});return $(t).html(o)}},r.fatal=function(n,e){throw r.render(n,"danger",e),new Error(n)},r.error=function(n,e){return r.render(n,"danger",e)},r.warn=function(n,e){return r.render(n,"warning",e)},r.info=function(n){return r.render(n,"info",selector)},r.ok=function(n){return r.render(n,"success",selector)}});
...
app.handler("project",function(e,n){e.create=function(e,r){return n.post(n.url("/api/admin/project/create"),{name:e},r)}});
...
app.controller("index",function(t,e,r){var n,a,o=$("#loader");t.init=function(){n=window._ctx.options,a=r.timeSpanToSeconds(n.past),e.chart.init({selector:"#chart",serverDelay:1e3*a,step:1e3*window._ctx.interval,stop:1==n.stop,type:n.type}),t.initScrollbars(),r.setIntervalAndRunNow(function(){e.chart.remove(),t.getNames(function(e){t.renderStats(e),t.plot(e),t.initTitles(e)})},6e5)},t.feed=function(t,r){return e.chart.metric(function(o,s,i,l){var c=[],u=0;o=(+o-a)/1e3,s=(+s-a)/1e3,i=+i/1e3;var f={name:t,type:n.type,start:o,stop:s};e.metric.getData(f,function(t,n){if(t)return e.error.fatal(t);for(;s>o;){for(;o<n.times[u];)o+=i,c.push(o>n.times[u]?n.vals[u]:0);c.push(n.vals[u++]),o+=i}l(null,c),r&&r(n)})},t)},t.getNames=function(t){var r={limit:n.limit,sort:n.sort};n.project?r.project=n.project:r.pattern=n.pattern,e.metric.getNames(r,function(r,n){return r?e.error.fatal(r):(o.hide(),void(t&&t(n)))})},t.plot=function(r){var n,a,o=[];for(a=0;a<r.names.length;a++)n=r.names[a][0],o.push(t.feed(n,t.refreshTitle));return e.chart.plot(o)},t.renderStats=function(t){var e=$("#template-query-statistics").html(),r=nunjucks.renderString(e,t);return $("#query-statistics").html(r)},t.initTitles=function(a){var o,s,i,l={};for(o=0;o<a.names.length;o++)s=a.names[o][0],i=a.names[o][1],l[s]=i;return e.chart.title(function(e){var a=$("#template-title").html(),o=l[e];return nunjucks.renderString(a,{name:e,trend:o,trendText:t.getTextByTrend(o),className:t.getClassNameByTrend(o),url:r.url("/",{pattern:e,sort:n.sort,limit:1,type:n.type,past:n.past})})})},t.refreshTitle=function(e){$(r.format("title-%s",e.name)).toggleClass(t.getClassNameByTrend(e.trend)),$(r.format("title-trend-%s",e.name)).html(t.getTextByTrend(e.trend))},t.getClassNameByTrend=function(t){return Math.abs(t)>=1?"anomalous":"normal"},t.getTextByTrend=function(t){return t>0?"↑":0>t?"↓":"-"},t.initScrollbars=function(){$(".chart-box-top").scroll(function(){$(".chart-box").scrollLeft($(".chart-box-top").scrollLeft())}),$(".chart-box").scroll(function(){$(".chart-box-top").scrollLeft($(".chart-box").scrollLeft())})}});
app.controller("project",function(e,r,t){var o=$("#form-create"),n=$("#modal-create"),i=$("#error-create");e.init=function(){e.initCreate()},e.initCreate=function(){$(o).submit(e.create),$(n).on("hidden.bs.modal",function(e){$(i).html("")})},e.create=function(e){e.preventDefault();var o=this,c=t.collectForm(o);r.project.create(c.name,function(e,t){return e?void r.error.error(e,i):void $(n).modal("hide")})}});