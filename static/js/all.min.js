...
app.controller("project",function(t,e,r){var o="#form-create",n="#modal-create",c="#error-create",a="#table-projects",i="#template-project-node";t.init=function(){t.initCreate(),t.list()},t.initCreate=function(){$(o).submit(t.create),$(n).on("hidden.bs.modal",function(t){$(c).html("")})},t.create=function(o){o.preventDefault();var i=this,l=r.collectForm(i);e.project.create(l.name,function(r,o){return r?void e.error.error(r,c):($(n).modal("hide"),e.error.ok("project created"),$(a).html(""),void t.list())})},t.list=function(t){e.project.getAll(function(t,e){var o,n,c,l;for(l=$(i).html(),o=0;o<e.length;o++)n=e[o],c=nunjucks.renderString(l,{project:n,url:r.url,createdAt:r.dateToString(n.createdAt),updatedAt:r.dateToString(n.updatedAt)}),$(a).append(c)})}});