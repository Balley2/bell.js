...
app.controller("project.edit",function(e,r,o){var t,i={};i.name={},i.name.form=$(".section-project-name form"),i.name.error=$(".section-project-name form .error"),i.del={},i.del.button=$(".section-project-delete button.project-delete-confirmed"),i.del.error=$(".section-project-delete .error"),i.rule={},i.rule.add={},i.rule.add.error=$(".section-project-rules .rule-add .error"),i.rule.add.form=$(".section-project-rules form.rule-add"),i.rule.list={},i.rule.list.error=$(".section-project-rules .rule-list .error"),i.rule.list.list=$(".section-project-rules .rule-list"),i.rule.list.template=$(".section-project-rules #template-rule-node"),i.rule.del={},i.rule.del.error=$(".section-project-rules .rule-list .error"),i.rule.del.button=$(".section-project-rules button.rule-delete"),i.receiver={},i.receiver.add={},i.receiver.add.error=$(".section-project-receivers .receiver-add .error"),i.receiver.add.form=$(".section-project-receivers form.receiver-add"),i.receiver.list={},i.receiver.list.error=$(".section-project-receivers .receiver-list .error"),i.receiver.list.list=$(".section-project-receivers .receiver-list"),i.receiver.list.list=$(".section-project-receivers .receiver-list #template-receiver-node"),e.init=function(){t=window._ctx.id,e.loadProject(),e.loadRules(),e.initEvents()},e.initEvents=function(){i.name.form.submit(e.patchName),i.del.button.click(e.deleteProject),i.rule.add.form.submit(e.addRule),i.receiver.add.form.submit(e.addReceiver)},e.loadProject=function(){r.project.get(t,function(e,t){return e?void r.error.error(e):void o.fillForm(i.name.form,t)})},e.loadRules=function(){r.rule.gets(t,function(o,t){return o?void r.error.error(o,i.rule.list.error):void t.forEach(e.appendRule)})},e.loadReceivers=function(){r.receivers.gets(t,function(o,t){return o?void r.error.error(o,i.receivers.list.error):void t.forEach(e.appendReceiver)})},e.appendRule=function(r,t){var l=i.rule.list.template.html(),n=nunjucks.renderString(l,{rule:r});i.rule.list.list.append(n);var d=o.format(".rule-list li[data-id*=%d]",r.id);$(d).appendTo(i.rule.list.list).show(t),$(d).find(".rule-delete").click(e.deleteRule)},e.removeRule=function(e){var r=o.format(".rule-list li[data-id*=%d]",e);$(r).hide(500,function(){$(r).remove()})},e.appendReceiver=function(e,r){},e.patchName=function(e){e.preventDefault();var l=o.collectForm(this);r.project.patch(t,l.name,function(e,o){return e?void r.error.error(e,i.name.error):void r.error.ok("Project name updated",i.name.error)})},e.deleteProject=function(e){r.project.del(t,function(e,t){return e?void r.error.error(e,i.del.error):(r.error.ok("Project deleted, redirecting page in 2 seconds..",i.del.error),void setTimeout(function(){window.location.href=o.url("/admin/project")},2e3))})},e.addRule=function(l){l.preventDefault();var n=o.collectForm(this),d=this;n.up="on"===n.up,n.down="on"===n.down,n.min=+n.min?+n.min:null,n.max=+n.max?+n.max:null,r.rule.add(t,n,function(o,t){return o?void r.error.error(o,i.rule.add.error):(r.error.ok("Rule added",i.rule.add.error),e.appendRule(t,500),void d.reset())})},e.deleteRule=function(o){var t=+$(this).data("id");r.rule.del(t,function(o,l){return o?void r.error.error(o,i.rule.del.error):(r.error.ok("Rule deleted",i.rule.del.error),void e.removeRule(t))})},e.addReceiver=function(e){e.preventDefault();var l=o.collectForm(this);l.email="on"===l.email,l.phone="on"===l.phone,r.receiver.add(t,l,function(e,o){return e?void r.error.error(e,i.receiver.add.error):void r.error.ok("Receiver added",i.receiver.add.error)})}});
...
app.controller("receiver",function(e,r,t){var i={};i.create={},i.create.form=$(".receiver-create form"),i.list={},i.list.list=$(".receiver-list .list-group"),i.list.template=$(".receiver-list #template-receiver-node"),e.init=function(){e.list(),e.initCreate()},e.append=function(e,r){var n=i.list.template.html(),o=nunjucks.renderString(n,{receiver:e,url:t.url});i.list.list.append(o);var l=t.format(".receiver-list li[data-id*=%d]",e.id);console.log($(l)),$(l).appendTo(i.list.list).show(r)},e.list=function(){r.receiver.getAll(function(t,i){return t?void r.error.error(t):void i.forEach(e.append)})},e.initCreate=function(){i.create.form.submit(function(i){i.preventDefault();var n=t.collectForm(this),o=this;n.universal="on"===n.universal,r.receiver.create(n,function(t,i){return t?void r.error.error(t):(e.append(i,500),o.reset(),void r.error.ok("Receiver created"))})})}});