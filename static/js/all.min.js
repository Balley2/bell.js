...
!function(t){function n(t){return t}function e(){}function r(t){return Math.floor(t/1e3)}function o(t){var n=t.indexOf("|"),e=t.substring(0,n),r=e.lastIndexOf(","),o=e.lastIndexOf(",",r-1),a=e.lastIndexOf(",",o-1);1e3*e.substring(a+1,o),1e3*e.substring(r+1);return t.substring(n+1).split(",").slice(1).map(function(t){return+t})}function a(t){if(!(t instanceof e))throw new Error("invalid context");this.context=t}function u(t,n){return function(e,r,o,a){t(new Date(+e+n),new Date(+r+n),o,a)}}function l(t,n){a.call(this,t),n=+n;var e=n+"";this.valueOf=function(){return n},this.toString=function(){return e}}function c(t,n){function e(n,e){if(e instanceof a){if(n.context!==e.context)throw new Error("mismatch context")}else e=new l(n.context,e);a.call(this,n.context),this.left=n,this.right=e,this.toString=function(){return n+" "+t+" "+e}}var r=e.prototype=Object.create(a.prototype);return r.valueAt=function(t){return n(this.left.valueAt(t),this.right.valueAt(t))},r.shift=function(t){return new e(this.left.shift(t),this.right.shift(t))},r.on=function(t,n){return arguments.length<2?this.left.on(t):(this.left.on(t,n),this.right.on(t,n),this)},function(t){return new e(this,t)}}function s(t){return 16777214&t}function f(t){return(t+1&16777214)-1}function h(t){t.style("position","absolute").style("top",0).style("bottom",0).style("width","1px").style("pointer-events","none")}function m(t){return t+"px"}var g=t.cubism={version:"1.6.0"},v=0;g.option=function(t,n){var e=g.options(t);return e.length?e[0]:n},g.options=function(t,n){for(var e,r=location.search.substring(1).split("&"),o=[],a=-1,i=r.length;++a<i;)(e=r[a].split("="))[0]==t&&o.push(decodeURIComponent(e[1]));return o.length||arguments.length<2?o:n},g.context=function(){function t(){var t=Date.now();return r=new Date(Math.floor((t-f-h)/c)*c),n=new Date(r-s*c),a=new Date(Math.floor((t-f)/c)*c),o=new Date(a-s*c),g.domain([n,r]),l}var n,r,o,a,i,u,l=new e,c=1e4,s=1440,f=5e3,h=5e3,m=d3.dispatch("prepare","beforechange","change","focus"),g=l.scale=d3.time.scale().range([0,s]);return l.start=function(){i&&clearTimeout(i);var t=+a+f-Date.now();return h>t&&(t+=c),i=setTimeout(function e(){a=new Date(Math.floor((Date.now()-f)/c)*c),o=new Date(a-s*c),m.prepare.call(l,o,a),setTimeout(function(){g.domain([n=o,r=a]),m.beforechange.call(l,o,a),m.change.call(l,o,a),m.focus.call(l,u)},h),i=setTimeout(e,c)},t),l},l.stop=function(){return i=clearTimeout(i),l},i=setTimeout(l.start,10),l.step=function(n){return arguments.length?(c=+n,t()):c},l.size=function(n){return arguments.length?(g.range([0,s=+n]),t()):s},l.serverDelay=function(n){return arguments.length?(f=+n,t()):f},l.clientDelay=function(n){return arguments.length?(h=+n,t()):h},l.focus=function(t){return m.focus.call(l,u=t),l},l.on=function(t,e){return arguments.length<2?m.on(t):(m.on(t,e),null!=e&&(/^prepare(\.|$)/.test(t)&&e.call(l,o,a),/^beforechange(\.|$)/.test(t)&&e.call(l,n,r),/^change(\.|$)/.test(t)&&e.call(l,n,r),/^focus(\.|$)/.test(t)&&e.call(l,u)),l)},d3.select(window).on("keydown.context-"+ ++v,function(){switch(!d3.event.metaKey&&d3.event.keyCode){case 37:null==u&&(u=s-1),u>0&&l.focus(--u);break;case 39:null==u&&(u=s-2),s-1>u&&l.focus(++u);break;default:return}d3.event.preventDefault()}),t()};var d=g.context.prototype=e.prototype;d.constant=function(t){return new l(this,+t)},d.cube=function(t){arguments.length||(t="");var n={},e=this;return n.metric=function(n){return e.metric(function(e,r,o,a){d3.json(t+"/1.0/metric?expression="+encodeURIComponent(n)+"&start="+p(e)+"&stop="+p(r)+"&step="+o,function(t){return t?void a(null,t.map(function(t){return t.value})):a(new Error("unable to load data"))})},n+="")},n.toString=function(){return t},n};var p=d3.time.format.iso;d.librato=function(t,n){function e(t){var n=avail_rsts[0],e=avail_rsts[avail_rsts.length];if(t>=e)return e;if(n>=t)return n;var r,o,a;for(a=t;e>=a;a++)if(r=avail_rsts.indexOf(a),r>-1){o=avail_rsts[r];break}var i;for(a=t;a>=n;a--)if(r=avail_rsts.indexOf(a),r>-1){i=avail_rsts[r];break}return t-i>o-t?o:i}function r(t,n,r){var o,a=n-t,i=2419200,u=604800,l=172800;return a>i?3600:(o=e(r),a>u&&900>o?900:a>l&&60>o?60:o)}var o={},a=this;auth_string="Basic "+btoa(t+":"+n),avail_rsts=[1,60,900,3600];var u=function(t){function n(n,e,a){var i="compose="+t+"&start_time="+n+"&end_time="+e+"&resolution="+r(n,e,a);return o+"?"+i}function e(t,n,e,r){var o=[];for(i=t;i<=n;i+=e){for(var a=[];r.length&&r[0].measure_time<=i;)a.push(r.shift().value);var u;u=a.length?a.reduce(function(t,n){return t+n})/a.length:o.length?o[o.length-1]:0,o.push(u)}return o}var o="https://metrics-api.librato.com/v1/metrics";return request={},request.fire=function(t,r,o,a){function i(l){d3.json(l).header("X-Requested-With","XMLHttpRequest").header("Authorization",auth_string).header("Librato-User-Agent","cubism/"+g.version).get(function(l,c){if(!l){if(0===c.measurements.length)return;c.measurements[0].series.forEach(function(t){u.push(t)});var s="query"in c&&"next_time"in c.query;if(s)i(n(c.query.next_time,r,o));else{var f=e(t,r,o,u);a(f)}}})}var u=[];i(n(t,r,o))},request};return o.metric=function(t){return a.metric(function(n,e,r,o){u(t).fire(y(n),y(e),y(r),function(t){o(null,t)})},t+="")},o.toString=function(){return"librato"},o};var y=function(t){return Math.floor(t/1e3)};d.graphite=function(t){arguments.length||(t="");var n={},e=this;return n.metric=function(n){var a="sum",i=e.metric(function(e,i,u,l){var c=n;1e4!==u&&(c="summarize("+c+",'"+(u%36e5?u%6e4?u/1e3+"sec":u/6e4+"min":u/36e5+"hour")+"','"+a+"')"),d3.text(t+"/render?format=raw&target="+encodeURIComponent("alias("+c+",'')")+"&from="+r(e-2*u)+"&until="+r(i-1e3),function(t){return t?void l(null,o(t)):l(new Error("unable to load data"))})},n+="");return i.summarize=function(t){return a=t,i},i},n.find=function(n,e){d3.json(t+"/metrics/find?format=completer&query="+encodeURIComponent(n),function(t){return t?void e(null,t.metrics.map(function(t){return t.path})):e(new Error("unable to find metrics"))})},n.toString=function(){return t},n},d.gangliaWeb=function(t){var n="",e="/ganglia2/";arguments.length&&(t.host&&(n=t.host),t.uriPathPrefix&&(e=t.uriPathPrefix,"/"!=e[0]&&(e="/"+e),"/"!=e[e.length-1]&&(e+="/")));var r={},o=this;return r.metric=function(t){var r=t.clusterName,a=t.metricName,i=t.hostName,u=t.isReport||!1,l=t.titleGenerator||function(t){return"clusterName:"+r+" metricName:"+a+(i?" hostName:"+i:"")},c=t.onChangeCallback,s=u?"g":"m",f=o.metric(function(t,o,u,l){function c(){return"c="+r+"&"+s+"="+a+(i?"&h="+i:"")+"&cs="+t/1e3+"&ce="+o/1e3+"&step="+u/1e3+"&graphlot=1"}d3.json(n+e+"graph.php?"+c(),function(t){return t?void l(null,t[0].data):l(new Error("Unable to fetch GangliaWeb data"))})},l(t));return f.toString=function(){return l(t)},c&&f.on("change",c),f},r.toString=function(){return n+e},r};var x=a.prototype;g.metric=a,x.valueAt=function(){return NaN},x.alias=function(t){return this.toString=function(){return t},this},x.extent=function(){for(var t,n=0,e=this.context.size(),r=1/0,o=-(1/0);++n<e;)t=this.valueAt(n),r>t&&(r=t),t>o&&(o=t);return[r,o]},x.on=function(t,n){return arguments.length<2?null:this},x.shift=function(){return this},x.on=function(){return arguments.length<2?null:this},d.metric=function(t,n){function e(n,e){var r=Math.min(m,Math.round((n-f)/h));if(r&&!i){i=!0,r=Math.min(m,r+b);var o=new Date(e-r*h);t(o,e,h,function(t,n){if(i=!1,t)return console.warn(t);for(var r=isFinite(f)?Math.round((o-f)/h):0,a=0,u=n.length;u>a;++a)g[a+r]=n[a];d.change.call(c,f,e)})}}function r(t,n){isFinite(f)||(f=t),g.splice(0,Math.max(0,Math.min(m,Math.round((t-f)/h)))),f=t,o=n}var o,i,l=this,c=new a(l),s=".metric-"+ ++v,f=-(1/0),h=l.step(),m=l.size(),g=[],d=d3.dispatch("change"),p=0;return c.valueAt=function(t){return g[t]},c.shift=function(n){return l.metric(u(t,+n))},c.on=function(t,n){return arguments.length?(null==n?null!=d.on(t)&&0==--p&&l.on("prepare"+s,null).on("beforechange"+s,null):null==d.on(t)&&1==++p&&l.on("prepare"+s,e).on("beforechange"+s,r),d.on(t,n),null!=n&&/^change(\.|$)/.test(t)&&n.call(l,f,o),c):d.on(t)},arguments.length>1&&(c.toString=function(){return n}),c};var b=6,w=l.prototype=Object.create(a.prototype);w.valueAt=function(){return+this},w.extent=function(){return[+this,+this]},x.add=c("+",function(t,n){return t+n}),x.subtract=c("-",function(t,n){return t-n}),x.multiply=c("*",function(t,n){return t*n}),x.divide=c("/",function(t,n){return t/n}),d.horizon=function(){function t(t){t.on("mousemove.horizon",function(){e.focus(Math.round(d3.mouse(this)[0]))}).on("mouseout.horizon",function(){e.focus(null)}),t.append("canvas").attr("width",a).attr("height",i),t.append("span").attr("class","title").text(s),t.append("span").attr("class","value"),t.each(function(t,s){function m(t,n){S.save();var l=w.extent();p=l.every(isFinite),null!=z&&(l=z);var c=0,s=Math.max(-l[0],l[1]);if(this===e){if(s==d){c=a-b;var f=(t-M)/R;if(a>f){var h=o.getContext("2d");h.clearRect(0,0,a,i),h.drawImage(S.canvas,f,0,a-f,i,0,0,a-f,i),S.clearRect(0,0,a,i),S.drawImage(h.canvas,0,0)}}M=t}u.domain([0,d=s]),S.clearRect(c,0,a-c,i);for(var m,g=0;N>g;++g){S.fillStyle=A[N+g];var v=(g-N+1)*i;u.range([N*i+v,v]),v=u(0);for(var y,x=c,D=a;D>x;++x)y=w.valueAt(x),0>=y?m=!0:void 0!==y&&S.fillRect(x,y=u(y),1,v-y)}if(m){"offset"===r&&(S.translate(0,i),S.scale(1,-1));for(var g=0;N>g;++g){S.fillStyle=A[N-1-g];var v=(g-N+1)*i;u.range([N*i+v,v]),v=u(0);for(var y,x=c,D=a;D>x;++x)y=w.valueAt(x),y>=0||S.fillRect(x,u(-y),1,v-u(-y))}}S.restore()}function g(t){null==t&&(t=a-1);var n=w.valueAt(t);D.datum(n).text(isNaN(n)?null:f)}var d,p,y=this,x=++v,w="function"==typeof l?l.call(y,t,s):l,A="function"==typeof h?h.call(y,t,s):h,z="function"==typeof c?c.call(y,t,s):c,M=-(1/0),R=e.step(),S=d3.select(y).select("canvas"),D=d3.select(y).select(".value"),N=A.length>>1;S.datum({id:x,metric:w}),S=S.node().getContext("2d"),e.on("change.horizon-"+x,m),e.on("focus.horizon-"+x,g),w.on("change.horizon-"+x,function(t,e){m(t,e),g(),p&&w.on("change.horizon-"+x,n)})})}var e=this,r="offset",o=document.createElement("canvas"),a=o.width=e.size(),i=o.height=30,u=d3.scale.linear().interpolate(d3.interpolateRound),l=n,c=null,s=n,f=d3.format(".2s"),h=["#08519c","#3182bd","#6baed6","#bdd7e7","#bae4b3","#74c476","#31a354","#006d2c"];return t.remove=function(t){function n(t){t.metric.on("change.horizon-"+t.id,null),e.on("change.horizon-"+t.id,null),e.on("focus.horizon-"+t.id,null)}t.on("mousemove.horizon",null).on("mouseout.horizon",null),t.selectAll("canvas").each(n).remove(),t.selectAll(".title,.value").remove()},t.mode=function(n){return arguments.length?(r=n+"",t):r},t.height=function(n){return arguments.length?(o.height=i=+n,t):i},t.metric=function(n){return arguments.length?(l=n,t):l},t.scale=function(n){return arguments.length?(u=n,t):u},t.extent=function(n){return arguments.length?(c=n,t):c},t.title=function(n){return arguments.length?(s=n,t):s},t.format=function(n){return arguments.length?(f=n,t):f},t.colors=function(n){return arguments.length?(h=n,t):h},t},d.comparison=function(){function t(t){t.on("mousemove.comparison",function(){e.focus(Math.round(d3.mouse(this)[0]))}).on("mouseout.comparison",function(){e.focus(null)}),t.append("canvas").attr("width",r).attr("height",o),t.append("span").attr("class","title").text(c),t.append("span").attr("class","value primary"),t.append("span").attr("class","value change"),t.each(function(t,c){function p(t,n){D.save(),D.clearRect(0,0,r,o);var i=z.extent(),u=M.extent(),l=null==R?i:R;a.domain(l).range([o,0]),b=i.concat(u).every(isFinite);var c=t/e.step()&1?f:s;D.fillStyle=g[2];for(var h=0,m=r;m>h;++h){var v=a(z.valueAt(h)),p=a(M.valueAt(h));p>v&&D.fillRect(c(h),v,1,p-v)}for(D.fillStyle=g[0],h=0;m>h;++h){var v=a(z.valueAt(h)),p=a(M.valueAt(h));v>p&&D.fillRect(c(h),p,1,v-p)}for(D.fillStyle=g[3],h=0;m>h;++h){var v=a(z.valueAt(h)),p=a(M.valueAt(h));p>=v&&D.fillRect(c(h),v,1,d)}for(D.fillStyle=g[1],h=0;m>h;++h){var v=a(z.valueAt(h)),p=a(M.valueAt(h));v>p&&D.fillRect(c(h),v-d,1,d)}D.restore()}function y(t){null==t&&(t=r-1);var n=z.valueAt(t),e=M.valueAt(t),o=(n-e)/e;N.datum(n).text(isNaN(n)?null:h),_.datum(o).text(isNaN(o)?null:m).attr("class","value change "+(o>0?"positive":0>o?"negative":""))}function x(t,e){p(t,e),y(),b&&(z.on("change.comparison-"+A,n),M.on("change.comparison-"+A,n))}var b,w=this,A=++v,z="function"==typeof i?i.call(w,t,c):i,M="function"==typeof u?u.call(w,t,c):u,R="function"==typeof l?l.call(w,t,c):l,S=d3.select(w),D=S.select("canvas"),N=S.select(".value.primary"),_=S.select(".value.change");D.datum({id:A,primary:z,secondary:M}),D=D.node().getContext("2d"),z.on("change.comparison-"+A,x),M.on("change.comparison-"+A,x),e.on("change.comparison-"+A,p),e.on("focus.comparison-"+A,y)})}var e=this,r=e.size(),o=120,a=d3.scale.linear().interpolate(d3.interpolateRound),i=function(t){return t[0]},u=function(t){return t[1]},l=null,c=n,h=A,m=z,g=["#9ecae1","#225b84","#a1d99b","#22723a"],d=1.5;return t.remove=function(t){function n(t){t.primary.on("change.comparison-"+t.id,null),t.secondary.on("change.comparison-"+t.id,null),e.on("change.comparison-"+t.id,null),e.on("focus.comparison-"+t.id,null)}t.on("mousemove.comparison",null).on("mouseout.comparison",null),t.selectAll("canvas").each(n).remove(),t.selectAll(".title,.value").remove()},t.height=function(n){return arguments.length?(o=+n,t):o},t.primary=function(n){return arguments.length?(i=n,t):i},t.secondary=function(n){return arguments.length?(u=n,t):u},t.scale=function(n){return arguments.length?(a=n,t):a},t.extent=function(n){return arguments.length?(l=n,t):l},t.title=function(n){return arguments.length?(c=n,t):c},t.formatPrimary=function(n){return arguments.length?(h=n,t):h},t.formatChange=function(n){return arguments.length?(m=n,t):m},t.colors=function(n){return arguments.length?(g=n,t):g},t.strokeWidth=function(n){return arguments.length?(d=n,t):d},t};var A=d3.format(".2s"),z=d3.format("+.0%");d.axis=function(){function t(o){var i,u=++v,l=o.append("svg").datum({id:u}).attr("width",n.size()).attr("height",Math.max(28,-t.tickSize())).append("g").attr("transform","translate(0,"+("top"===r.orient()?27:4)+")").call(r);n.on("change.axis-"+u,function(){l.call(r),i||(i=d3.select(l.node().appendChild(l.selectAll("text").node().cloneNode(!0))).style("display","none").text(null))}),n.on("focus.axis-"+u,function(t){if(i)if(null==t)i.style("display","none"),l.selectAll("text").style("fill-opacity",null);else{i.style("display",null).attr("x",t).text(a(e.invert(t)));var n=i.node().getComputedTextLength()+6;l.selectAll("text").style("fill-opacity",function(r){return Math.abs(e(r)-t)<n?0:1})}})}var n=this,e=n.scale,r=d3.svg.axis().scale(e),o=n.step()<6e4?M:n.step()<864e5?R:S,a=o;return t.remove=function(t){function e(t){n.on("change.axis-"+t.id,null),n.on("focus.axis-"+t.id,null)}t.selectAll("svg").each(e).remove()},t.focusFormat=function(n){return arguments.length?(a=null==n?o:n,t):a==o?null:n},d3.rebind(t,r,"orient","ticks","tickSubdivide","tickSize","tickPadding","tickFormat")};var M=d3.time.format("%I:%M:%S %p"),R=d3.time.format("%I:%M %p"),S=d3.time.format("%B %d");d.rule=function(){function t(t){var n=++v,o=t.append("div").datum({id:n}).attr("class","line").call(h);t.each(function(n,o){function a(n,r){for(var o=[],a=0,i=e.size();i>a;++a)l.valueAt(a)&&o.push(a);var u=t.selectAll(".metric").data(o);u.exit().remove(),u.enter().append("div").attr("class","metric line").call(h),u.style("left",m)}var i=this,u=++v,l="function"==typeof r?r.call(i,n,o):r;l&&(e.on("change.rule-"+u,a),l.on("change.rule-"+u,a))}),e.on("focus.rule-"+n,function(t){o.datum(t).style("display",null==t?"none":null).style("left",null==t?null:m)})}var e=this,r=n;return t.remove=function(t){function n(t){e.on("focus.rule-"+t.id,null)}t.selectAll(".line").each(n).remove()},t.metric=function(n){return arguments.length?(r=n,t):r},t}}(this);
