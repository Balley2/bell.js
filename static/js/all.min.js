...
app.util.secondsToString=function(t){var r=new Date(1e3*t),n=r.getMonth()+1,e=r.getDate(),o=r.getHours(),s=r.getMinutes(),u=r.getSeconds();return n=("00"+n).slice(-2),e=("00"+e).slice(-2),o=("00"+o).slice(-2),s=("00"+s).slice(-2),u=("00"+u).slice(-2),[n,e].join("/")+" "+[o,s,u].join(":")},app.util.format=function(){var t=arguments,r=t[0],n=1;return r.replace(/%((%)|s|d|f)/g,function(r){if(r[2])return r[2];var e=t[n++];switch(r){case"%d":return parseInt(e);case"%f":return parseFloat(e);case"%s":return e.toString()}})},app.util.url=function(t,r){var n,e=[];if("/"!==t[0])throw new Error("except route starts with /");if(window._ctx.root&&(t="/"+window._ctx.root+t),r)for(n in r)e.push([n,"=",r[n]].join(""));return t+"?"+e.join("&")},app.util.get=function(t,r){return $.ajax({type:"GET",url:t,dataType:"json",success:function(t){return r(null,t)},error:function(t,n){var e=JSON.parse(t.responseText),o=n+":"+e.msg,s=new Error(o);return r(s,null)}})},app.util.post=function(t,r,n){return $.ajax({type:"POST",url:t,dataType:"json",contentType:"application/json",processData:!1,data:JSON.stringify(r),success:function(t){return n(null,t)},error:function(t,r){var e=JSON.parse(t.responseText),o=r+":"+e.msg,s=new Error(o);return n(s,null)}})},app.util.timeSpanToSeconds=function(t){for(var r,n,e,o,s={s:1,m:60,h:3600,d:86400},u=0;t.length>0;){for(r=0;r<t.length;r++)if(n=t[r],e=s[n],!isNaN(e)){o=+t.slice(0,r),u+=o*e,t=t.slice(r+1);break}if(r===t.length)return u}return u},app.util.setIntervalAndRunNow=function(t,r){return t(),setInterval(t,r)};
...
app.handler("config",function(n,i){n.get=function(n){return i.get(i.url("/api/config"),n)}});
app.handler("error",function(r,n){var e="#error",t=$("#template-error").html();r.render=function(r,n){if(r){var u=nunjucks.renderString(t,{className:n,msg:r.toString()});return $(e).html(u)}},r.fatal=function(n){return r.render(n,"danger")},r.error=function(n){return r.render(n,"danger")},r.warn=function(n){return r.render(n,"warning")},r.info=function(n){return r.render(n,"info")},r.ok=function(n){return r.render(n,"success")}});
...
app.handler("project",function(n,p){});
