...
function buildUrlParams(e){var t=[];for(var n in e)t.push([n,"=",e[n]].join(""));return t.join("&")}function timespan2secs(e){for(var t={s:1,m:60,h:3600,d:86400},n=0;e.length>0;){for(var a=0;a<e.length;a++){var r=e[a],s=t[r];if(!isNaN(s)){var i=+e.slice(0,a);n+=i*s,e=e.slice(a+1);break}}if(a===e.length)return n}return n}function secs2str(e){var t=new Date(1e3*e),n=t.getMonth()+1,a=t.getDate(),r=t.getHours(),s=t.getMinutes(),i=t.getSeconds();return n=("00"+n).slice(-2),a=("00"+a).slice(-2),r=("00"+r).slice(-2),s=("00"+s).slice(-2),i=("00"+i).slice(-2),[n,a].join("/")+" "+[r,s,i].join(":")}function sprintf(){var e=[].slice.apply(arguments,[0,1])[0],t=[].slice.apply(arguments,[1]);return e.replace(/{(\d+)}/g,function(e,n){return"undefined"!=typeof t[n]?t[n]:e})}!function(){function e(e,t){var n=new XMLHttpRequest;n.open("GET",e,!0),n.send(),n.onreadystatechange=function(){if(4===n.readyState&&200===n.status){var e=JSON.parse(n.responseText);t(e)}}}function t(t){return f.metric(function(n,r,s,i){n=(+n-m)/1e3,r=(+r-m)/1e3,s=+s/1e3;var l=[api,"datapoints"].join("/")+"?"+buildUrlParams({name:t,type:o,start:n,stop:r}),c=[],u=0;e(l,function(e){for(;r>n;){for(;n<e.times[u];)n+=s,c.push(n>e.times[u]?e.vals[u]:0);c.push(e.vals[u++]),n+=s}i(null,c),a(t,e.trend)}),p.innerHTML=secs2str(r)},t)}function n(){var e=f.horizon();return"m"===o?e.extent([-2,2]).mode("mirror").colors(["#dd1144","teal","teal","#dd1144"]):"v"===o?e:void 0}function a(e,t){document.getElementById(sprintf("title-{0}",e)).className=Math.abs(t)>=1?"anomalous":"normal",document.getElementById(sprintf("title-trend-{0}",e)).innerHTML=t>0?"↑":"↓"}function r(){var a={limit:l,sort:i};d?a.dashboard=d:a.pattern=s;var r=[api,"names"].join("/")+"?"+buildUrlParams(a);e(r,function(e){h.style.display="none";for(var a=e.total,r=e.mcount,s=[],l={},u=0;u<e.names.length;u++)s.push(t(e.names[u][0])),l[e.names[u][0]]=e.names[u][1];var d;d=0===a?"info":0==r?"success":r/a>.5?"danger":"warning",document.getElementById("info-total").innerHTML=a,document.getElementById("info-mcount").innerHTML=r,document.getElementById("info-returns").innerHTML=e.names.length,document.getElementById("main-info").className=sprintf("alert alert-dismissible alert-{0}",d),d3.select("#chart").call(function(e){e.append("div").attr("class","axis").call(f.axis().orient("top")),e.selectAll(".horizon").data(s).enter().append("div").attr("class","horizon").call(n()),e.append("div").attr("class","rule").call(f.rule())}),d3.selectAll(".title").html(function(e){var t=e.toString(),n={pattern:t,sort:i,limit:1,type:o,past:c},a=l[t],r=a>0?"↑":"↓",s=Math.abs(a)>=1?"anomalous":"normal",u=root+"?"+buildUrlParams(n);return sprintf('<a id="title-{3}" class="{0}" href="{1}"><span id="title-trend-{3}">{2} </span> {3}</a>',s,u,r,t)})})}var s,i,l,o,c,u,d,m,f=cubism.context().serverDelay(0).clientDelay(0).size(1080),p=document.getElementById("chart-until"),h=(document.getElementById("chart-timestep"),document.getElementById("loader"));this.initBell=function(e){s=e.pattern,i=e.sort,l=e.limit,o=e.type,c=e.past,u=e.stop,d=e.dashboard,m=timespan2secs(c),f.serverDelay(1e3*m).step(1e3*step),1===u&&f.stop(),r(),0===u&&setInterval(function(){d3.select("#chart").selectAll("*").remove(),r()},6e5)},f.on("focus",function(e){offset=document.getElementById("chart").offsetWidth-e,d3.selectAll(".value").style("right",null===e?null:offset+"px")})}(this);