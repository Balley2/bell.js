...
app.util.dateToString=function(t){t instanceof Date||(t=new Date(t));var r=t.getFullYear(),e=t.getMonth()+1,n=t.getDate(),a=t.getHours(),u=t.getMinutes(),s=t.getSeconds();return r=""+r,e=("00"+e).slice(-2),n=("00"+n).slice(-2),a=("00"+a).slice(-2),u=("00"+u).slice(-2),s=("00"+s).slice(-2),[r,e,n].join("/")+" "+[a,u,s].join(":")},app.util.format=function(){var t=arguments,r=t[0],e=1;return r.replace(/%((%)|s|d|f)/g,function(r){if(r[2])return r[2];var n=t[e++];switch(r){case"%d":return parseInt(n);case"%f":return parseFloat(n);case"%s":return n.toString()}})},app.util.url=function(t,r){var e,n=[];if("/"!==t[0])throw new Error("except route starts with /");if(window._ctx.root&&(t="/"+window._ctx.root+t),r)for(e in r)n.push([e,"=",r[e]].join(""));var a=t+"?"+n.join("&");return a.replace(/\?$/g,"")},app.util.get=function(t,r){return $.ajax({type:"GET",url:t,dataType:"json",success:function(t){return r(null,t)},error:function(t,e){var n,a,u;try{n=JSON.parse(t.responseText).msg}catch(s){n=t.responseText}return a=app.util.format("%s: %s",t.status,n),u=new Error(a),r(u,null)}})},app.util.post=function(t,r,e){return $.ajax({type:"POST",url:t,dataType:"json",contentType:"application/json",processData:!1,data:JSON.stringify(r),success:function(t){return e(null,t)},error:function(t,r){var n,a,u;try{n=JSON.parse(t.responseText).msg}catch(s){n=t.responseText}return a=app.util.format("%s: %s",t.status,n),u=new Error(a),e(u,null)}})},app.util["delete"]=function(t,r){return $.ajax({type:"DELETE",url:t,processData:!1,success:function(){return r(null,null)},error:function(t,e){var n,a,u;try{n=JSON.parse(t.responseText).msg}catch(s){n=t.responseText}return a=app.util.format("%s: %s",t.status,n),u=new Error(a),r(u,null)}})},app.util.timeSpanToSeconds=function(t){for(var r,e,n,a,u={s:1,m:60,h:3600,d:86400},s=0;t.length>0;){for(r=0;r<t.length;r++)if(e=t[r],n=u[e],!isNaN(n)){a=+t.slice(0,r),s+=a*n,t=t.slice(r+1);break}if(r===t.length)return s}return s},app.util.setIntervalAndRunNow=function(t,r){return t(),setInterval(t,r)},app.util.collectForm=function(t){var r={};return $(t).serializeArray().map(function(t){t.name&&(r[t.name]=t.value)}),r},app.util.fillForm=function(t,r){$(t).find("input,textarea").each(function(t,e){e.name in r&&$(e).val(r[e.name])})},app.util.render=function(t,r,e){var n=$(t).html(),a=nunjucks.renderString(n,e);return $(r).html(a)};
...
app.handler("project",function(e,t){e.create=function(e,n){return t.post(t.url("/api/admin/project"),{name:e},n)},e.getAll=function(e){return t.get(t.url("/api/projects"),e)},e["delete"]=function(e,n){return t["delete"](t.url("/api/admin/project/"+e),n)},e.get=function(e,n){return t.get(t.url("/api/admin/project/"+e),n)}});
