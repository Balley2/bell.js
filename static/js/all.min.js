...
app.handler("error",function(r,n){var t="#error",e=$("#template-error").html();r.fatal=function(r){if(r){var n=nunjucks.renderString(e,{type:"danger",msg:r.toString()});return $(t).html(n)}}});
